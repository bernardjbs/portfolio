<template>
  <footer class="footer-section column items-center text-center text-white">
    ...
    <div class="q-gutter-md row items-center q-mb-lg">
      ...
      <a :href="hero.github" target="_blank" rel="noopener" class="footer-link">
        <svg viewBox="0 0 24 24" width="18" height="18" fill="white" class="q-mr-xs">
      ...
      <a :href="hero.linkedin" target="_blank" rel="noopener" class="footer-link">
        <svg viewBox="0 0 24 24" width="18" height="18" fill="white" class="q-mr-xs">
...
import { footer } from 'src/data/content'
</script>
